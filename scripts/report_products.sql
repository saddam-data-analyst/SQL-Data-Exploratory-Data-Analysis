...
Highlight:
	...
	2. Segment products by revenue to highlight to indentify High-Performers, Mid_Range and Low-Performers.
...
WITH base_query AS (
--Step 1: Retrieve Core columns from facts_sales and dim_products
	SELECT
		f.order_number,
		f.order_date,
		f.customer_key,
